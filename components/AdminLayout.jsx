...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white shadow-md fixed top-0 left-0 right-0 z-40">
        <div className="flex items-center justify-between px-4 h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/" target="_blank" className="text-gray-600 hover:text-primary-600">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Sidebar */}
      <aside className={`fixed top-16 left-0 bottom-0 w-64 bg-white shadow-lg transition-transform duration-300 z-30 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <nav className="p-4">
