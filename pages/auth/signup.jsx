          ...
          <div className="mx-auto grid max-w-4xl overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(16,21,28,0.08)] lg:grid-cols-[.9fr_1.1fr]">
            <div className="hidden bg-[#10151c] p-8 text-white lg:flex lg:flex-col lg:justify-between lg:p-10">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-black tracking-[-0.05em]">Save your part enquiries and orders.</h2>
                <p className="mt-4 text-sm leading-7 text-slate-400">Create an account with your WhatsApp number so you can return to your cart and order history.</p>
              </div>
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="text-sm text-gray-500">We'll verify your WhatsApp number</span>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-1 space-y-1">
                    <p className="text-xs text-gray-500 flex items-center gap-1">
                      ...
                      Enter your 10-digit WhatsApp number (this will be your login username)
                    </p>
                    <p className="text-xs text-green-600 flex items-center gap-1">
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      Must be active on WhatsApp for order updates
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600">
                  ...
                  <Link href="/auth/login" className="text-[#dc4310] hover:text-[#b9380c] font-bold">
                    Log In
                  </Link>
                </p>
              </div>
