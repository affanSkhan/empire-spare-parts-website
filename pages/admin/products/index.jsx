              ...
              <div key={product.id} className="bg-white rounded-xl shadow-md p-4 border border-gray-200">
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 flex items-center justify-center px-4 py-2 bg-[#ff5b1f] text-white rounded-lg hover:bg-[#dc4310] transition-all font-medium shadow-md text-sm"
                  >
